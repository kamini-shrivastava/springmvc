...
public class Edit {
	...
	@RequestMapping("/edit")
	public ModelAndView edit(@RequestParam("bcode") int bookscode, @RequestParam("bname") String booksname,
			@RequestParam("select") String authors, @RequestParam("date") String adddates) {
